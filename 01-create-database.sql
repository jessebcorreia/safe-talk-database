...
CREATE TABLE unidade_ensino (
    ...
    CONSTRAINT fk_unidade_ensino_endereco
...
CREATE TABLE curso (
    ...
    CONSTRAINT fk_curso_unidade_ensino
    FOREIGN KEY (unidade_ensino_id)     REFERENCES unidade_ensino(id)
...
CREATE TABLE usuario (
    ...
    email           VARCHAR(100)    NOT NULL UNIQUE,
    senha           VARCHAR(255)    NOT NULL,
    cargo           ENUM('UNIDADE_ENSINO', 'ANALISTA', 'PEDAGOGO', 'ALUNO'),
    criado_em       DATETIME        NOT NULL DEFAULT CURRENT_TIMESTAMP,
    atualizado_em   DATETIME,
...
CREATE TABLE denuncia (
    ...
    tipo        ENUM('VIOLENCIA_FISICA', 'VIOLENCIA_VERBAL', 'CYBER_BULLYING') NOT NULL,
    criado_em   DATETIME        NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT fk_denuncia_local_fato
    FOREIGN KEY (local_fato_id) REFERENCES endereco(id)
...
CREATE TABLE denuncia_vitima (
    ...
    CONSTRAINT fk_denuncia_vitima_denuncia
    FOREIGN KEY (denuncia_id)   REFERENCES denuncia(id)
    ON DELETE CASCADE           ON UPDATE CASCADE,

    CONSTRAINT fk_denuncia_vitima_vitima
    FOREIGN KEY (vitima_id)     REFERENCES usuario(id)
    ON DELETE CASCADE           ON UPDATE CASCADE
);
...
CREATE TABLE denuncia_agressor (
    ...
    CONSTRAINT fk_denuncia_agressor_denuncia
    FOREIGN KEY (denuncia_id)   REFERENCES denuncia(id)
    ON DELETE CASCADE           ON UPDATE CASCADE,

    CONSTRAINT fk_denuncia_agressor_agressor
    FOREIGN KEY (agressor_id)   REFERENCES usuario(id)
    ON DELETE CASCADE           ON UPDATE CASCADE
);
...
CREATE TABLE denuncia_pedagogo (
    ...
    CONSTRAINT fk_denuncia_pedagogo_denuncia
    FOREIGN KEY (denuncia_id)   REFERENCES denuncia(id)
    ON DELETE CASCADE           ON UPDATE CASCADE,

    CONSTRAINT fk_denuncia_pedagogo_pedagogo
    FOREIGN KEY (pedagogo_id)   REFERENCES usuario(id)
    ON DELETE CASCADE           ON UPDATE CASCADE
);
...
CREATE TABLE andamento (
    id          INT             AUTO_INCREMENT PRIMARY KEY,
    conteudo    TEXT            NOT NULL,
    tipo        ENUM('ARQUIVAMENTO','DESARQUIVAMENTO','PARECER_FINAL','INFORMACAO_COMPLEMENTAR','ANALISE','REUNIAO','OBSERVACAO') NOT NULL,
    criado_em   DATETIME        NOT NULL DEFAULT CURRENT_TIMESTAMP,

    denuncia_id INT             NOT NULL,
    autor_id    INT             NOT NULL,

    CONSTRAINT fk_andamento_denuncia
    FOREIGN KEY (denuncia_id)   REFERENCES denuncia(id)
    ON DELETE CASCADE           ON UPDATE CASCADE,

    CONSTRAINT fk_andamento_autor
    FOREIGN KEY (autor_id)      REFERENCES usuario(id)
    ON DELETE CASCADE           ON UPDATE CASCADE
);
...
CREATE TABLE andamento_arquivamento (
    ...
    motivo          ENUM('DENUNCIA_DUPLICADA', 'DENUNCIA_INCOMPLETA', 'FATO_JA_APURADO', 'FATO_ATIPICO') NOT NULL,

    CONSTRAINT fk_andamento_arquivamento_andamento
...
CREATE TABLE andamento_desarquivamento (
    ...
    CONSTRAINT fk_andamento_desarquivamento_andamento
    FOREIGN KEY (andamento_id)  REFERENCES andamento(id)
    ON DELETE CASCADE           ON UPDATE CASCADE
);
...
CREATE TABLE andamento_analise (
    ...
    CONSTRAINT fk_andamento_analise_andamento
    FOREIGN KEY (andamento_id)  REFERENCES andamento(id)
    ON DELETE CASCADE           ON UPDATE CASCADE
);
...
CREATE TABLE andamento_reuniao (
    ...
    CONSTRAINT fk_andamento_reuniao_andamento
    FOREIGN KEY (andamento_id)  REFERENCES andamento(id)
    ON DELETE CASCADE           ON UPDATE CASCADE
);
...
CREATE TABLE andamento_parecer_final (
    andamento_id    INT         PRIMARY KEY,
    resultado ENUM('DENUNCIA_PROCEDENTE', 'DENUNCIA_IMPROCEDENTE', 'PARECER_INCONCLUSIVO') NOT NULL,
    atualizado_em   DATETIME,

    CONSTRAINT fk_andamento_parecer_final_andamento
    FOREIGN KEY (andamento_id)  REFERENCES andamento(id)
    ON DELETE CASCADE           ON UPDATE CASCADE
);
...
ALTER TABLE curso
ADD COLUMN analista_id INT,
ADD CONSTRAINT fk_curso_analista
    FOREIGN KEY (analista_id)   REFERENCES usuario(id)
    ON DELETE RESTRICT          ON UPDATE CASCADE;

ALTER TABLE turma
ADD COLUMN pedagogo_id INT,
ADD CONSTRAINT fk_turma_pedagogo
    FOREIGN KEY (pedagogo_id) REFERENCES usuario(id)
    ON DELETE CASCADE           ON UPDATE CASCADE;
